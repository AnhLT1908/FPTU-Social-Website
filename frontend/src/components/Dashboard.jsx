                    ...
                    <Col md={4}>
                        <Card className="dashboard-custom-card">
                            <Card.Body className="dashboard-card-body">
                                ...
                                <Card.Text className="dashboard-card-text">{totalReports}</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card className="dashboard-custom-card">
                            <Card.Body className="dashboard-card-body">
                                ...
                                <Card.Text className="dashboard-card-text">{unprocessedReports}</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card className="dashboard-custom-card">
                            <Card.Body className="dashboard-card-body">
                                ...
                                <Card.Text className="dashboard-card-text">{processedReports}</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
